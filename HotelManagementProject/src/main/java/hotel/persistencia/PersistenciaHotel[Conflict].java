...
public class PersistenciaHotel {
			...
			char cafetera, int consumo, char ocupado, Date reserva, Date inicioMantenimiento, Date finMantenimiento)
	{
        ...
        try
        {
            ...
            return new Habitacion(id, tipo, capacidad, comedorCocina, jacuzzi, television, minibar, cafetera, consumo, ocupado, tuplasInsertadas, reserva, inicioMantenimiento, finMantenimiento);
        }
        catch (Exception e)
        {
        	log.error ("Exception : " + e.getMessage() + "\n" + darDetalleException(e));
			...
			int costo, char cargaConsumo, char costoIncluido, Date horario, Date inicioMantenimiento, Date finMantenimiento)
	{
        ...
        try
        {
            ...
            return new ServicioAdicional(id, nombre, ofrece, reserva, capacidad, incluyePlanConsumo, costo, cargaConsumo, costoIncluido, horario, inicioMantenimiento, finMantenimiento);
        }
        catch (Exception e)
        {
        	log.error ("Exception : " + e.getMessage() + "\n" + darDetalleException(e));
